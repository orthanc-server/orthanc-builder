...
viewerContainerId=$(docker create osimis/osimis-webviewer-pro:1.1.0.0) # CHANGE_VERSION
...
viewerContainerIdAlpha=$(docker create osimis/osimis-webviewer-pro:1.1.0.0) # CHANGE_VERSION
