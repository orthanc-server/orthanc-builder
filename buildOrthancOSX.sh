...
# Orthanc core
wget "${URL}/Orthanc 1.9.6 - OS X Release/Orthanc"
wget "${URL}/Orthanc 1.9.6 - OS X Release/libModalityWorklists.dylib"
wget "${URL}/Orthanc 1.9.6 - OS X Release/libServeFolders.dylib"
wget "${URL}/Orthanc 1.9.6 - OS X Release/libConnectivityChecks.dylib"
