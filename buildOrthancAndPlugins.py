...
repositories = {
    'orthanc': {
        ...
        'stableBranch': 'Orthanc-1.9.7', # CHANGE_VERSION_ORTHANC
    ...
    'orthancwebviewer': {
        'platforms': ALL_PLATFORMS,
        'stableBranch': '2.8', # CHANGE_VERSION_ORTHANC_WEB_VIEWER
        'nightlyBranch': 'default',
        ...
        'stableBranch': 'OrthancWebViewer-2.8',  # CHANGE_VERSION_ORTHANC_WEB_VIEWER
        'nightlyBranch': 'default',
        'outputLibs': ['OrthancWebViewer'],        
    },
    'dicomweb': {
        ...
        'stableBranch': 'OrthancDicomWeb-1.7',  # CHANGE_VERSION_DW
        'nightlyBranch': 'default',
    ...
    'wsiplugin': {
        ...
        'stableBranch': 'OrthancWSI-1.1', # CHANGE_VERSION_WSI
        'nightlyBranch': 'default',
    ...
    'mysql': {
        ...
        'stableBranch': 'OrthancMySQL-4.3', # CHANGE_VERSION_MYSQL
        'nightlyBranch': 'default',
