...
viewerContainerId=$(docker create osimis/orthanc-webviewer-plugin:0.9.1)  # CHANGE_VERSION
...
docker build --tag=osimis/orthanc:17.6.1 --file=orthanc/Dockerfile .  # CHANGE_VERSION
