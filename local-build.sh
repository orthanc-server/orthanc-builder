...
if [[ $type == "local" ]]; then
    ...
    echo "https://public-files.orthanc.team/tmp-builds/docker-builds/$platform/$BASE_UBUNTU_IMAGE/$ORTHANC_TESTS_COMMIT_ID-orthanc-tests-tar.gz" > "/tmp/$version-orthanc-tests-archive-path"
