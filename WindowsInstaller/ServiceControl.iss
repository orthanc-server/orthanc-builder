{
This code comes from: https://stackoverflow.com/a/3219486/881731

Modifications:
- "string" in external functions has been replaced by "AnsiString":
  https://stackoverflow.com/a/9687888/881731
- The "SERVICE_XXX_PENDING" status are taken into consideration
  in "IsServiceRunning()"
}
    ...
    if hSCM <> 0 then begin
        ...
        if hService <> 0 then begin
            if QueryServiceStatus(hService,Status) then begin
                { Original code: "Status.dwCurrentState = SERVICE_RUNNING" }
                Result := ((Status.dwCurrentState <> SERVICE_STOPPED) AND
