...
docker cp $dockerContainerId:/tmp/OsimisInstaller/OrthancInstaller-Win32-21.9.0.exe .  # CHANGE_VERSION_WIN_INSTALLER
...
docker cp $dockerContainerId:/tmp/OsimisInstaller/OrthancInstaller-Win64-21.9.0.exe .  # CHANGE_VERSION_WIN_INSTALLER
docker rm $dockerContainerId
...
docker cp OrthancInstaller-Win32-21.9.0.exe $awsContainerId:/tmp
docker cp OrthancInstaller-Win64-21.9.0.exe $awsContainerId:/tmp
