...
docker cp $dockerContainerId:/tmp/OsimisInstaller/OrthancInstaller-Win32-21.6.0.exe .  # CHANGE_VERSION_WIN_INSTALLER
...
dockerContainerId=$(docker create installer-builder)
docker cp $dockerContainerId:/tmp/OsimisInstaller/OrthancInstaller-Win64-21.6.0.exe .  # CHANGE_VERSION_WIN_INSTALLER
docker rm $dockerContainerId
