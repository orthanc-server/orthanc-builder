...
docker cp $dockerContainerId:/tmp/OsimisInstaller/OrthancInstaller-Win32-18.12.3.exe .  # CHANGE_VERSION_WIN_INSTALLER
...
dockerContainerId=$(docker create installer-builder)
docker cp $dockerContainerId:/tmp/OsimisInstaller/OrthancInstaller-Win64-18.12.3.exe .  # CHANGE_VERSION_WIN_INSTALLER
docker rm $dockerContainerId
