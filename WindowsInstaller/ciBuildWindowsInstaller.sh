...
docker cp $dockerContainerId:/tmp/OsimisInstaller/OrthancInstaller-Win32-19.2.1.exe .  # CHANGE_VERSION_WIN_INSTALLER
...
dockerContainerId=$(docker create installer-builder)
docker cp $dockerContainerId:/tmp/OsimisInstaller/OrthancInstaller-Win64-19.2.1.exe .  # CHANGE_VERSION_WIN_INSTALLER
docker rm $dockerContainerId
