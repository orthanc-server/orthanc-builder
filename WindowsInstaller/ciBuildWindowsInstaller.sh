...
docker cp $dockerContainerId:/tmp/OsimisInstaller/OrthancInstaller-Win32-21.1.7.exe .  # CHANGE_VERSION_WIN_INSTALLER
...
dockerContainerId=$(docker create installer-builder)
docker cp $dockerContainerId:/tmp/OsimisInstaller/OrthancInstaller-Win64-21.1.7.exe .  # CHANGE_VERSION_WIN_INSTALLER
docker rm $dockerContainerId
