...
docker cp $dockerContainerId:/tmp/OsimisInstaller/OrthancInstaller-Win32-17.6.0.exe .  # CHANGE_VERSION
...
dockerContainerId=$(docker create installer-builder)
docker cp $dockerContainerId:/tmp/OsimisInstaller/OrthancInstaller-Win64-17.6.0.exe .  # CHANGE_VERSION
docker rm $dockerContainerId
