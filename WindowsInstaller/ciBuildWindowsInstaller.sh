...
docker cp $dockerContainerId:/tmp/WindowsInstaller/orthanc.json .
docker cp $dockerContainerId:/tmp/WindowsInstaller/OrthancInstaller-Win32.exe .
...
docker cp $dockerContainerId:/tmp/WindowsInstaller/OrthancInstaller-Win64.exe .
docker rm $dockerContainerId
