...
docker cp $dockerContainerId:/tmp/OsimisInstaller/OrthancInstaller-Win32-20.12.0.exe .  # CHANGE_VERSION_WIN_INSTALLER
...
dockerContainerId=$(docker create installer-builder)
docker cp $dockerContainerId:/tmp/OsimisInstaller/OrthancInstaller-Win64-20.12.0.exe .  # CHANGE_VERSION_WIN_INSTALLER
docker rm $dockerContainerId
