...
docker cp $dockerContainerId:/tmp/OsimisInstaller/OrthancInstaller-Win32-22.3.0.exe .  # CHANGE_VERSION_WIN_INSTALLER
...
docker cp $dockerContainerId:/tmp/OsimisInstaller/OrthancInstaller-Win64-22.3.0.exe .  # CHANGE_VERSION_WIN_INSTALLER
docker rm $dockerContainerId
...
docker cp OrthancInstaller-Win32-22.3.0.exe $awsContainerId:/tmp   # CHANGE_VERSION_WIN_INSTALLER
