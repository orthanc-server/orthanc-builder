...
- upgraded Orthanc Explorer 2 plugin to [1.15.0](https://github.com/orthanc-server/orthanc-explorer-2/blob/master/release-notes.md)
- upgraded Advanced Storage plugin [0.3.2](https://github.com/orthanc-server/orthanc-advanced-storage/blob/master/release-notes.md)
- upgraded advanced authorization plugin to [0.12.0](https://orthanc.uclouvain.be/hg/orthanc-authorization/file/default/NEWS)
...
- upgraded advanced authorization plugin to [0.11.4](https://orthanc.uclouvain.be/hg/orthanc-authorization/file/default/NEWS)
- DOCKER:
...
- upgraded Advanced Storage plugin [0.3.1](https://github.com/orthanc-server/orthanc-advanced-storage/blob/master/release-notes.md)


26.4.1
------

- upgraded advanced authorization plugin to [0.11.3](https://orthanc.uclouvain.be/hg/orthanc-authorization/file/default/NEWS)
- upgraded Orthanc Explorer 2 plugin to [1.12.0](https://github.com/orthanc-server/orthanc-explorer-2/blob/master/release-notes.md)
...
- upgraded PostgreSQL plugins to [10.1](https://orthanc.uclouvain.be/hg/orthanc-databases/file/default/PostgreSQL/NEWS)
